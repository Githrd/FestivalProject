...
<body>
	...
	if (!userID.equals(bbs.getUserID())) {
		...
		|| request.getParameter("bbsTitle") == "" || request.getParameter("bbsContent") == "" || request.getParameter("rating") == null) {
			PrintWriter script = response.getWriter();
			script.println("<script>");
			...
			int result = bbsDAO.update(bbsID, request.getParameter("bbsTitle"), request.getParameter("bbsContent"), Integer.parseInt(request.getParameter("rating")));
			if (result == -1) {
		PrintWriter script = response.getWriter();
		script.println("<script>");
